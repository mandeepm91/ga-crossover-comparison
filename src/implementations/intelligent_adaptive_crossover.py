...
import numpy
from .common import eaSimpleIntelligentCrossover, initialize_toolbox, initialize_toolbox_one_max
...
def run_one_max_problem_with_intelligent_adaptive_crossover(
        problem_size = 0,
        fitness_function = None,
        initial_population_size = POPULATION_SIZE,
        max_number_of_generations = MAX_GENERATIONS,
