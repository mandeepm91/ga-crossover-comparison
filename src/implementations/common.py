...
def extract_operator_from_name(str_representation_of_function_name):
    if 'cxOnePoint' in str_representation_of_function_name:
        return tools.cxOnePoint
    elif 'cxTwoPoint' in str_representation_of_function_name:
        return tools.cxTwoPoint
    elif 'cxUniform' in str_representation_of_function_name:
